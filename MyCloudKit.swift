...
class Singleton {
    ...
    private init() {
        if FileManager.default.ubiquityIdentityToken != nil {
            ...
            myCloudKit = MyCloudKit()
            cloudKitActiveMeditationsUpdater = CKActiveMeditationListUpdater()
        }
    }
    
    var myCloudKit:MyCloudKit?
    var cloudKitActiveMeditationsUpdater:CKActiveMeditationListUpdater?
